  ...
  return (
    ...
    viewport={{ once: true }}
      ...
      <div className='flex flex-col md:flex-row items-center md-items-start md:gap-20'>
        <img src={assets.brand_img} alt="brand" className='w-full sm:w-1/2 max-w-lg'></img>
        <div className='flex flex-col items-center md-items-start mt-10 text-gray-600'>
            <div className='grid grid-cols-2 md:grid-cols-2 gap-6 md-gap-10 w-full 2xl:pr-28'>
                <div>
